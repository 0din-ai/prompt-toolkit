...
**Usage:**
```rust
use odin_sig::{sign_text, SigError};
...
class SigError(Exception):
    """Base exception for all odin-sig operations."""
...
**Usage:**
```python
from odin_sig import sign_text, SigError, ProviderError, InvalidInputError
...
**Usage:**
```typescript
import { signText, SigError, ProviderError, InvalidInputError } from '@0din/sig';
...
```python
from odin_sig import LshConfig, ConfigError
...
```typescript
import { ConfigError } from '@0din/sig';
...
from odin_sig import ProviderError
...
import { ProviderError } from '@0din/sig';
...
from odin_sig import ModelError
...
import { ModelError } from '@0din/sig';
...
```rust
use odin_sig::{parse_signature_string, SigError};
...
```python
from odin_sig import parse_signature_string, InvalidInputError
...
```typescript
import { parseSignatureString, InvalidInputError } from '@0din/sig';
...
```python
import asyncio
from odin_sig import sign_text, SignatureVersion, ProviderError
...
```typescript
import { signText, SignatureVersion, ProviderError } from '@0din/sig';
...
```python
from odin_sig import sign_text, ProviderError, ModelError
from odin_sig.providers import OpenAIProvider, OnnxProvider, ModelCache
