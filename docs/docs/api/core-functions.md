...
**Example:**
```rust
use odin_sig::hamming_distance_hex;
...
**Example:**
```typescript
import { hammingDistanceHex } from '@0din/sig';
...
**Example:**
```rust
use odin_sig::{hamming_distance_hex, cosine_from_hamming};
...
**Example:**
```typescript
import { hammingDistanceHex, cosineFromHamming } from '@0din/sig';
...
**Example:**
```rust
use odin_sig::{normalize_vector, compute_embedding_sha256};
...
**Example:**
```typescript
import { normalizeVector, computeEmbeddingSha256 } from '@0din/sig';
