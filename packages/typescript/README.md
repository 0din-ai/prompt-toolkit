...
```bash
npm install git+https://github.com/0din/sig-sdk.git#main:typescript
# or
yarn add git+https://github.com/0din/sig-sdk.git#main:typescript
# or
pnpm add git+https://github.com/0din/sig-sdk.git#main:typescript
```
