...
class SusFactorOnnxClassifier:
    ...
    async def classify(self, text: str) -> ChunkedSusFactorResult:
        ...
        concurrency depends on the ONNX Runtime session configuration; a
        single shared session serializes inference internally. Dispatching
        concurrently allows the runtime to schedule work efficiently.
