...
| V1      | ONNX     | 0dinai/jailbreak-embeddings-base-onnx | 768        | 256            | LSH       | Stable       |
| Latest  | →V1      | —                                     | —          | —              | —         | Alias        |
...
#### V1: ONNX 0dinai/jailbreak-embeddings-base-onnx

- **Provider**: Local ONNX inference
- **Model**: `0dinai/jailbreak-embeddings-base-onnx` (contrastively fine-tuned for jailbreak/prompt similarity detection)
- **Dimensions**: 768
- **Signature**: 256-bit LSH (3 families, 16 bands)
...
- V1: 768-dimensional 0dinai/jailbreak-embeddings-base-onnx space
...
V2:
  Provider: ONNX
  Model: 0dinai/jailbreak-embeddings-base-onnx
  Dimensions: 768
